    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <div class="flex min-h-screen bg-gray-100">
            <aside class="w-35 bg-gray-500 shadow-md px-5 py-2 space-y-4">
                <nav class="space-y-2">
                    <a href="{{ route('registro_ingresos.create') }}" class="block px-5 py-2 rounded hover:bg-gray-700 text-white font-medium">Registrar nuevo ingreso</a>
                </nav>
            </aside>

            <main class="p-6 w-full">
                <h2 class="text-2xl font-semibold text-gray-800 mb-4">Lista de Ingresos</h2>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium flex items-center justify-end gap-4">
                                    <a href="{{ route('ingresos.edit', $ingreso->id) }}" class="text-indigo-600 hover:text-indigo-900">Editar</a>
                                    <form class="inline-block" action="{{ route('ingresos.destroy', $ingreso->id) }}" method="POST" onsubmit="return confirm('¿Estás seguro de que deseas eliminar este ingreso?')">
                                        @csrf
                                        @method('DELETE')
