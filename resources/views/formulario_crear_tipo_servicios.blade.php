...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white p-8 rounded-lg shadow-xl border-4 border-gray-400 w-11/12 md:w-3/4 lg:w-1/2">
        ...
        <div class="flex flex-col items-center justify-center mb-6">
            ...
            <h1 class="text-3xl italic font-serif text-gray-800 text-center">Crear un nuevo servicio</h1>
        </div>
        ...
        <form action="{{ route('tipo_servicios.store') }}" method="POST" class="space-y-4">
            ...
            @endif
            @csrf
            <table class="w-full"> {{-- La tabla ocupará todo el ancho del contenedor --}}
                <tr>
