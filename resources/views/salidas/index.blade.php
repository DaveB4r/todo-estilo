    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <div class="flex min-h-screen bg-gray-100">
            <aside class="w-35 bg-gray-500 shadow-md px-5 py-2 space-y-4">
                <nav class="space-y-2">
                    <a href="{{ route('salidas.create') }}" class="block px-5 py-2 rounded hover:bg-gray-700 text-white font-medium">Registrar nueva salida</a>
                </nav>
            </aside>

            <main class="p-6 w-full">
                <div class="flex justify-center w-full">
                    <h1 class="text-3xl italic font-serif text-gray-800">Lista de salidas</h1>
                </div>
                @if(session('success'))
