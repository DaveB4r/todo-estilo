...
<body class="bg-gray-100 flex items-center justify-center min-h-screen p-4">
    ...
    <div class="bg-white p-8 rounded-lg shadow-xl border-4 border-gray-400 w-11/12 md:w-3/4 lg:w-1/2">
        ...
        <div class="flex flex-col items-center justify-center mb-6">
            ...
            <h1 class="text-3xl italic font-serif text-gray-800 text-center">Editar cuenta por cobrar</h1>
        </div>

        <form action="{{ route('cuentas_por_cobrar.update', $cuentaPorCobrar) }}" method="POST" class="space-y-4">
            @if ($errors->any())
            ...
            <table class="w-full">
                <tr>
                    ...
                    <td>
                        <input
                            ...
                            value="{{ old('fecha', $cuentaPorCobrar->fecha) }}"
                            required
                        >
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input
                            ...
                            id="valor"
                            class="w-full border border-gray-300 rounded shadow-sm h-10 px-3 text-base"
                            value="{{ old('valor', $cuentaPorCobrar->valor) }}"
                            required
                            min="0"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        >{{ old('observaciones', $cuentaPorCobrar->observaciones) }}</textarea>
                    </td>
                </tr>
