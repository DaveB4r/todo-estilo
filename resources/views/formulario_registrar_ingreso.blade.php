...
<div class="ml-4 flex items-center">
    <h1 class="text-3xl italic font-serif text-gray-800">Registrar Ingreso</h1>
</div>

<form action="{{ route('registro_ingresos.store') }}" method="POST" class="mt-6">
    @if ($errors->any())
        ...
        <tr>
            ...
            <td>
                <select name="entrada" id="entrada" class="w-full border border-gray-300 rounded shadow-sm h-10 px-3 text-base" required>
                    ...
                    <option value="Ajuste de cierre">Ajuste de cierre</option>
